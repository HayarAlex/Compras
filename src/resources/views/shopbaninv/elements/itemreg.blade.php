...
@include('compras::shopbaninv.elements.templates.row-item')
...
<script>
        ...
        Vue.component("row-item", {
            ...
            methods: {
                ...
                update: function () {
                    var vms = this;
                    destroyTable();
                    axios.put('/compras/shopbinv', this.draft)
    ...
    $(document).on("click", "a.aprov", function () {
        ...
        console.log(codigo);
        destroyTable();
        axios.put('/compras/shopbinv/apro/'+codigo)
            .then(function (response) {
    ...
    $(document).on("click", "a.reprov", function () {
        ...
        console.log(codigo);
        destroyTable();
        axios.put('/compras/shopbinv/repro/'+codigo)
            .then(function (response) {
