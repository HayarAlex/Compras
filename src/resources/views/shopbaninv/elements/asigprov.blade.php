...
@section('content')
    <h2 class="page-header">Pedido Pendiente de Revision - Inv. Desarrollo</h2>

    <div id="app" class="row">
        <div class="col-md-3">
            @include('compras::shopbaninv.elements.iteminfo')
            @include('compras::shopbaninv.elements.itemconfirm')           
            
        </div>
        <div class="col-md-9">
            @include('compras::shopbaninv.elements.itemreg')
        </div>
        <div class="col-md-3">
            {{--@include('compras::shopban5.elements.itemprogress')--}} 
            {{--@include('compras::shopbansan.elements.itemdoc')--}}          
