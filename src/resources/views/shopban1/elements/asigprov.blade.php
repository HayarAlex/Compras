...
@section('content')
    <h2 class="page-header">Asignacion de Proveedores</h2>

    <div id="app" class="row">
        <div class="col-md-3">
            @include('compras::shopban1.elements.iteminfo')
            @include('compras::shopban1.elements.itemconfirm')           
            
        </div>
        <div class="col-md-3">
            @include('compras::shopban1.elements.itemlist')
        </div>
        <div class="col-md-4">
            @include('compras::shopban1.elements.itemreg')
        </div>
        <div class="col-md-2">
            @include('compras::shopban1.elements.itemadd')
        </div>
    </div>
@endsection
