              ...
              <table role="presentation" style="width:100%;border-collapse:collapse;border:0;border-spacing:0;">
                <tr>
                  <td style="padding:0 0 36px 0;color:#153643;">
                    <h2 style="font-size:20px;margin:0 0 20px 0;font-family:Arial,sans-serif;">Administración Compras - MAC - Inv. y Desarrollo</h2>
                  </td>
                </tr>
                  <td style="padding:0;">
                    <table role="presentation" style="width:100%;border-collapse:collapse;border:0;border-spacing:0;">
                      ...
                      <tr>
                        <td id="grl">
                          <p id="texto">ESTADO DE REVISION :</p>
                        </td>
                        <td id="prm">&nbsp;</td>
                        <td id="seg">
                          <p id="textores">PEDIDO APROBADO</p>
                        </td>
                      </tr>
