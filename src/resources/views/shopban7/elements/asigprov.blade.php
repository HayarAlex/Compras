...
@section('content')
    <h2 class="page-header">Pedido Aprobado - Orden de Compra</h2>

    <div id="app" class="row">
        <div class="col-md-8">
            {{--@include('compras::shopban7.elements.testh')--}} 
            @include('compras::shopban7.elements.itemlist')
        </div>
        <div class="col-md-4">
            @include('compras::shopban7.elements.iteminfo')
            {{--@include('compras::shopban7.elements.itemorden')--}} 
            @include('compras::shopban7.elements.itemreg')
            {{--@include('compras::shopban7.elements.itemdoc')--}}        
