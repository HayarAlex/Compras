    ...
    <div class="box-body">
        <table id="dt-list" class="table table-bordered table-striped table-hover">
            ...
            <tr>
                ...
                <th width="8%" class="text-center no-padding">N° DOCUMENTOS</th>
                <th width="12%"></th>
            </tr>
            </thead>
            <tbody>
...
@include('compras::shopban7.elements.templates.row-item')
@include('compras::shopban7.elements.templates.modaltipo')
@include('compras::shopban7.elements.templates.modaldocprov')
