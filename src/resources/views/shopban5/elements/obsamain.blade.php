...
@section('content')
    <h2 class="page-header">Pedidos Observados por Areas</h2>

    <div id="app" class="row">
        <div class="col-md-3">
            @include('compras::shopban5.elements.iteminfo')

            @include('compras::shopban5.elements.obsconfirm')           
            
        </div>
        <div class="col-md-6">
            @include('compras::shopban5.elements.obslist')
        </div>
        <div class="col-md-3">
            @include('compras::shopban5.elements.itemprogress')
            @include('compras::shopban2.elements.itemconfirm')
            {{-- @include('compras::shopban5.elements.itemdoc') --}}          
