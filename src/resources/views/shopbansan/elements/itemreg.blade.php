...
@include('compras::shopbansan.elements.templates.row-item')
...
<script>
        ...
        Vue.component("row-item", {
            ...
            methods: {
                ...
                update: function () {
                    var vms = this;
                    destroyTable();
                    axios.put('/compras/shopban', this.draft)
    ...
    $(document).on("click", "a.aprov", function () {
        ...
        console.log(codigo);
        destroyTable();
        axios.put('/compras/shopban/apro/'+codigo)
            .then(function (response) {
    ...
    $(document).on("click", "a.reprov", function () {
        ...
        console.log(codigo);
        destroyTable();
        axios.put('/compras/shopban/repro/'+codigo)
            .then(function (response) {
