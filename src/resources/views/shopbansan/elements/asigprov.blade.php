...
@section('content')
    <h2 class="page-header">Pedido Pendiente de Revision - Reg Sanitario</h2>

    <div id="app" class="row">
        <div class="col-md-3">
            @include('compras::shopbansan.elements.iteminfo')
            @include('compras::shopbansan.elements.itemconfirm')           
            
        </div>
        <div class="col-md-9">
            @include('compras::shopbansan.elements.itemreg')
        </div>
        <div class="col-md-3">
