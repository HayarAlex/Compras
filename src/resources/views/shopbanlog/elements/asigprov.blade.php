...
@section('content')
    <h2 class="page-header">Pedido Pendiente de Revision - Logistica</h2>

    <div id="app" class="row">
        <div class="col-md-3">
            @include('compras::shopbanlog.elements.iteminfo')
            @include('compras::shopbanlog.elements.itemconfirm')           
            
        </div>
        <div class="col-md-9">
            @include('compras::shopbanlog.elements.itemreg')
        </div>
        <div class="col-md-3">
            {{--@include('compras::shopban5.elements.itemprogress')--}}
            {{--@include('compras::shopbanlog.elements.itemdoc')--}}        
