...
@section('content')
    <h2 class="page-header">Pedido Pendiente de Aprobacion</h2>

    <div id="app" class="row">
        <div class="col-md-3">
            @include('compras::shopban6.elements.iteminfo')
            @include('compras::shopban6.elements.itemconfirm')           
            
        </div>
        <div class="col-md-9">
            @include('compras::shopban6.elements.itemreg')
        </div>
        <div class="col-md-3">
            {{--@include('compras::shopban5.elements.itemprogress')--}}
            {{--@include('compras::shopban6.elements.itemdoc')--}}        
