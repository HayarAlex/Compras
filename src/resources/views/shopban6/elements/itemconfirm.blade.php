            ...
            <table class="table table-condensed table-striped">
                ...
                <tr>
                    ...
                    <td width="65%" class='no-padding'>
                        {!! Former::text('fen', '')
                                  ->class('sel7 form-control input-sm text-uppercase')->autocomplete('off')!!}
                    </td>
                </tr>
...
<script>
    ...
    var enviost = {{ $list->staterevend }};
    var revi = {{ $revss[0]->idshrev }};
    ...
    function send () {
        ...
        $("#btn-create").prop("disabled", true);
        formForms = $('#form-add');
        var vcoment = document.querySelector('.sel7').value;
        ...
        console.log(obj);
        axios.put('/compras/shopbsix/aproba', obj)
            .then(function (response) {
                toastrSuccess();
                window.location.href = "/compras/shopbsix";
            })
    ...
    function observar () {
        ...
        $("#btn-observ").prop("disabled", true);
        formForms = $('#form-add');
        var vdesc = document.querySelector('.sel7').value;
        ...
        axios.put('/compras/shopbsix/observation', obj)
            .then(function (response) {
                toastrSuccess();
                window.location.href = "/compras/shopbsix";
            })
