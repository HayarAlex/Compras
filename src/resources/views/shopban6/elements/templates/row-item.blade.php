        ...
        <tr>
            <template v-if="!editing">
                ...
                <td class="text-center">
                    ...
                    <a href="#" v-if="item.stcal == 0" class="aprov" :data-ida="item.iddetsh" :data-des="item.detpsh">
                        <i class="fa fa-check-square" style="color: green"></i>
                    </a>&nbsp;
                    <a href="#" v-if="item.stcal == 0" class="reprov"  :data-idr="item.iddetsh" :data-des="item.detpsh">
